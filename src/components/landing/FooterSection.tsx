      ...
      <div className="container px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-base font-semibold">JournalXPro</span>
            </div>

            <p className="text-sm text-muted-foreground leading-7 max-w-xs">
              The trading journal built for traders who value precision,
              discipline, and consistency over noise.
            </p>
          </div>
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} JournalXPro. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
